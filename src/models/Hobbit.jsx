...
import hobbit from '../assets/3D/hobbit.glb'
import { a } from '@react-spring/three'

const Hobbit = (props) => {

  const { nodes, materials } = useGLTF(hobbit)
  const hobbitRef = useRef()

  return (
    <a.group ref={hobbitRef} {...props}>
...
useGLTF.preload('/hobbit_house_-_low_poly.glb')
